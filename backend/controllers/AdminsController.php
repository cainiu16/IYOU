...
class AdminsController extends Controller
{
	public function actionTravel()
	{
        ...
        $command = $connection->createCommand("select * from travel inner join city on travel.c_id=city.c_id inner join season on travel.s_id=season.s_id where travel.t_del=1 limit $limit2,$pagesize");
       //执行查询的sql语句,查询返回多行：
	...
	public function actionDoaddtravel()
	{
        ...
        $b = $model->t_p_img = UploadedFile::getInstance($model, 't_p_img');
            ...
            $t_p_img = 'www.imgss.com/'.$model->t_p_img->name;
