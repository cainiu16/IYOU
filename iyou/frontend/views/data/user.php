            ...
            <div class="ucenter-info mt10">
                <div class="info">
                    ...
                    <div style="float:right">
                        <?= HTML::button('修改',['style'=>'width:200px;height:30px;background:#fff;font-size:16','id'=>'button']) ?>
                    </div>
                    <script>
                        $(function(){
                        ...
                        <table>
                            ...
                            <?php
                                foreach($goods as $k=>$v){
                                    ?>
                                    <tr>
                                        <td class="list"><?= $v['g_name']?></td>
                                        <td class="list"><img src="<?php if($v['g_img']==''){echo "aa";}else{echo $v['g_img'];}?>"  onerror="javascript:this.src='images/errors.jpg'" width='60%'/></td>
